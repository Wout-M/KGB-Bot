...
module.exports = {
    ...
    run(client) {
        ...
        client.user
            .setPresence({ activity: { name: "over you", type: "WATCHING" }, status: "dnd" })
            .then((presence) => {
                console.log(
        ...
        for(server in Servers) {
            ...
            !Servers[server].logChannelID ? console.log(chalk.red("\tAdd a log channel")) : console.log(chalk.inverse("\tLog channel configured"))
        }
